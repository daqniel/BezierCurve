...
CubicBezierPatch::CubicBezierPatch()
{
	...
	//CubicBezier u1, u2, u3, d;
	//u1.setControlPoints(controlNet[0].pos, controlNet[1].pos, controlNet[3].pos, controlNet[6].pos);
...
void CubicBezierPatch::drawControlNormals(Shader* s, glm::mat4 view, glm::mat4 projection)
{
